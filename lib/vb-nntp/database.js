...
var Database = module.exports = function Database(options, logger) {
  ...
  this._conn.initSync();
  this._conn.setOptionSync(conn.MYSQL_OPT_RECONNECT, 1);
  this._conn.setOptionSync(conn.MYSQL_OPT_CONNECT_TIMEOUT, 7*24*60*60);
  this._conn.setOptionSync(conn.MYSQL_INIT_COMMAND, "SET NAMES utf8");
  ...
  this.vbconfig = getVbulletinConfig.call(this);
};
