...
// synchronously reads VBulletin config from database. used in constructor.
...
var vbconfig = null;
Database.prototype.__defineGetter__(function () {
  if (null === vbconfig) {
    vbconfig = getVbulletinConfig.call(this);
  }
